(define (problem strips-grid-y-2)
   ...
   (:init (arm-empty)      
          ...
          (place node5-3)
          (place node5-4)
          (place node5-5)          ;;Frem hertil kan laves som "place :grid 6 6"
          (shape triangle)
          (shape diamond)
          (shape square)
          (shape circle)
                                   ;; Forbind alle neighbors med :connect-neighbors eller nedenstående
          ...
          ;;Hver nøgle befinder sig på en bestemt node i griddet
          (key key0)
